...
public class PhotoPopupWindow extends PopupWindow {
	...
	private OnClickListener mSelectListener; // 相册选取的点击监听器
	private OnClickListener mCaptureListener; // 拍照的点击监听器

	public PhotoPopupWindow(Activity context, OnClickListener selectListener, OnClickListener captureListener) {
		super(context);
